...
%
\author{Jean-Sebastian de Wet\inst{1} \and
Jan-Philipp Kiel\inst{1} \and
Pascal Mager\inst{1} \and
Tobias Schlauch\inst{2}}
%
\authorrunning{Group Criterion}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{University of Cologne, Cologne, Germany \and
German Aerospace Center, Institute for Software Technology, Braunschweig, Germany}
%
